...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (sendWhatsAppBtn) {
    sendWhatsAppBtn.addEventListener('click', function(){
      ...
      let message = `Hello Bake with Crystal,%0A%0AMy name: ${name}%0APhone: ${phone}%0AOrder: ${item}%0ADate: ${date} ${time}%0AType: ${mode}%0AAddress: ${address}%0ANotes: ${notes}%0ADelivery fee: ₦${fee}%0A%0AThank you.`;
